    ...
    return (
        <NoSSR>
            <div className={`text-primaryDark`}>
                <h1 className={`font-bold text-[2rem] text-black`}>Popcorn Statistics</h1>
                ...
                <div className={`grid md:grid-cols-2 gap-[2rem]`}>
                    ...
                    <div className={`flex flex-col bg-[#FAF9F4] border border-warmGray rounded-[1rem]`}>
                        <div className={`h-[4rem] flex gap-2 border-b border-[#353945] px-[1.5rem]`}>
                            <p className={`text-[1rem] my-auto text-black`}>Total Stats</p>
                        </div>
                    ...
                    <div className={`flex flex-col bg-[#FAF9F4] border border-warmGray rounded-[1rem]`}>
                        <div className={`h-[4rem] flex gap-2 border-b border-[#353945] px-[1.5rem]`}>
                            <span className={`flex flex-col my-auto`}>
                                <p className={`text-[0.75rem] text-black`}>Total Value locked</p>
                    ...
                    <div className={`col-span-full grid md:grid-cols-1 gap-2`}>
                        <h2 className={`text-[1.5rem] font-bold text-black`}>{'Snapshot PIP\'s'}</h2>
                        <div className={`flex flex-col bg-[#FAF9F4] border border-warmGray rounded-[1rem]`}>
                            <div className={`min-h-[4rem] max-h-[4rem] grid grid-cols-[2.5rem_1fr] gap-[1rem] md:grid-cols-[2.5rem_1fr_1fr_3rem] content-center border-b border-[#353945] px-[1.5rem] text-black`}>
                                <span>#</span>
                                <span>Title</span>
