    ...
    <>
      ...
      <div className="flex justify-between items-center mt-2 w-full">
        <div className="flex items-center ml-1 gap-2 cursor-pointer group/max" onClick={onMaxClick}>
          <div className="mt-1 text-secondaryLight group-hover/max:text-primary">
          ...
          <p className="text-secondaryLight group-hover/max:text-primary">
        ...
        {getTokenUrl && (
          ...
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5 ml-4">
