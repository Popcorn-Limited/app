  ...
  return (
    <div className="space-y-8 mb-8 text-start">
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-row items-center justify-between text-secondaryLight">
          <p>Returned Amount</p>
          <p className="text-[#141416]">{amount > 0 ? (amount * 0.75).toFixed(2) : "0"} POP</p>
        </div>
        <div className="flex flex-row items-center justify-between text-secondaryLight">
      ...
      <div className="w-full bg-[#fa5a6e26] border border-customRed rounded-lg p-4">
        <p className="text-customRed">Important: Unlocking your POP early will results in a penalty of {(amount * 0.25).toFixed(2)} POP</p>
      </div>
