const LiquidityGaugeAbi = [
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "name": "_voting_escrow_delegation",
        "type": "address"
      },
      {
        "name": "_admin",
...
export default LiquidityGaugeAbi;